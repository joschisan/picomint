...
mod tests {
    ...
    fn creates_initial_unit() {
        ...
        let round = 0;
        let creator = Creator::new(PeerId::new(0_u8), n_members);
    ...
    fn creates_unit_with_minimal_parents_4() {
        create_unit_with_minimal_parents(NumPeers::new(4_usize));
    }

    #[test]
    fn creates_unit_with_minimal_parents_5() {
        create_unit_with_minimal_parents(NumPeers::new(5_usize));
    }

    #[test]
    fn creates_unit_with_minimal_parents_6() {
        create_unit_with_minimal_parents(NumPeers::new(6_usize));
    }

    #[test]
    fn creates_unit_with_minimal_parents_7() {
        create_unit_with_minimal_parents(NumPeers::new(7_usize));
    }
    ...
    fn cannot_create_unit_below_parents_threshold_4() {
        dont_create_unit_below_parents_threshold(NumPeers::new(4_usize));
    }

    #[test]
    fn cannot_create_unit_below_parents_threshold_5() {
        dont_create_unit_below_parents_threshold(NumPeers::new(5_usize));
    }

    #[test]
    fn cannot_create_unit_below_parents_threshold_6() {
        dont_create_unit_below_parents_threshold(NumPeers::new(6_usize));
    }

    #[test]
    fn cannot_create_unit_below_parents_threshold_7() {
        dont_create_unit_below_parents_threshold(NumPeers::new(7_usize));
    }
    ...
    fn creates_unit_with_ancient_parents() {
        let n_members = NumPeers::new(7_usize);
        let mut creator = Creator::new(PeerId::new(0_u8), n_members);
