...
Requires Docker with the compose plugin. Download [`docker-compose.yml`](docker-compose.yml), which runs the node and Bitcoin Core side by side, then pull and start:
